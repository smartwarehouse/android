...
public class StatistikTiapBarangFragment extends Fragment {
    public StatistikTiapBarangFragment(){};

    public ListView lv1;
    public com.github.mikephil.charting.charts.BarChart chrt1;
    public Spinner sp1, sp2, sp3;

    public static StatistikTiapBarangFragment newInstance() { return new StatistikTiapBarangFragment(); }
...
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview = inflater.inflate(R.layout.statistik_tiap_barang_fragment, container, false);

        sp1 = (Spinner) rootview.findViewById(R.id.kategori_spinner1);
        sp2 = (Spinner) rootview.findViewById(R.id.stat_spinner3);
