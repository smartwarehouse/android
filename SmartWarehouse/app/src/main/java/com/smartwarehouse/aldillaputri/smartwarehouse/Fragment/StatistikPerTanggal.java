...
public class StatistikPerTanggal extends Fragment {
    public StatistikPerTanggal(){};

    public ListView lv1;
    public com.github.mikephil.charting.charts.BarChart chrt1;
    public Spinner sp1, sp2, sp3;

    public static StatistikPerTanggal newInstance() { return new StatistikPerTanggal(); }
...
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview = inflater.inflate(R.layout.statistik_per_tanggal, container, false);

        sp1 = (Spinner) rootview.findViewById(R.id.stat_spinner1);
        sp2 = (Spinner) rootview.findViewById(R.id.stat_spinner2);
        sp3 = (Spinner) rootview.findViewById(R.id.stat_spinner3);
