...
public class StatistikRetur extends Fragment {
    public StatistikRetur(){};

    public ListView lv1;
    public com.github.mikephil.charting.charts.BarChart chrt1;
    public Spinner sp1, sp2, sp3;

    public static StatistikRetur newInstance() { return new StatistikRetur(); }
...
//    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootview = inflater.inflate(R.layout.statistik_retur, container, false);
